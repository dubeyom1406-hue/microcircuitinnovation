...
const About = () => {
    ...
    return (
        <div className="about-page mobile-full-width" style={{ background: '#000', color: '#fff', overflowX: 'hidden', width: '100%', maxWidth: '100vw', boxSizing: 'border-box' }}>
            ...
            >
                <h2 style={{ fontSize: 'clamp(1.2rem, 3vw, 2rem)', color: '#fff', marginBottom: '1rem' }}>
