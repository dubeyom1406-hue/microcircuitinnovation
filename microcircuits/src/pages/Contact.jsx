...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Contact message submission functionality temporarily disabled
    ...
    return (
        <div className="contact-page mobile-full-width" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '5rem 1rem 2rem', background: '#000', fontFamily: '"Outfit", sans-serif', width: '100%', maxWidth: '100vw', boxSizing: 'border-box' }}>
            <motion.div
